...
<body>
    <div class="gestion page">
        <section class="page-content">
            ...
            <div class="container">
                <form id="file-upload-form" action="controllers/controller_ms_convert.php" method="post" enctype="multipart/form-data">
                    ...
                    <button class="submit-btn" type="submit" id="convert-button" data-loading-text="Conversion en cours...">
                         Convertir
                    </button>
    ...
    <script>
	    document.addEventListener("DOMContentLoaded", function () {
			...
			// Ajouter du texte distinct en dessous du message de succès
                	...
                	additionalText.textContent = 'Lien pour afficher le menu: https://affichage.lpjw.local/menu.jpg';
