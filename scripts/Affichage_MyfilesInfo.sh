    ...
    lancer_chromium() {
        ...
        /usr/bin/chromium-browser --kiosk --noerrdialogs http://affichage.lpjw.local/display_info.php https://lpjw.fr/ecrans/menu.jpg https://lpjw.fr /home/pi/barInfo.html &
    }
