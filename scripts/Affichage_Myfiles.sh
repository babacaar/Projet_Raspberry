...
lancer_chromium() {
 ...
 /usr/bin/chromium-browser --kiosk --noerrdialogs https://affichage.lpjw.local/display_info.php https://affichage.lpjw.local/menupeda.jpg https://affichage.lpjw.local/menu.jpg https://affichage.lpjw.local/display_absences.php &
}
